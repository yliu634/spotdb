...
SHARED_LIB1 = libspotkv.$(PLATFORM_SHARED_EXT)
...
ifeq ($(PLATFORM), IOS)
$(DEVICE_OUTDIR)/libspotkv.a: $(DEVICE_LIBOBJECTS)
	rm -f $@
	$(AR) -rs $@ $(DEVICE_LIBOBJECTS)

$(SIMULATOR_OUTDIR)/libspotkv.a: $(SIMULATOR_LIBOBJECTS)
	rm -f $@
...
# a device.
$(STATIC_OUTDIR)/libspotkv.a: $(STATIC_OUTDIR) $(DEVICE_OUTDIR)/libspotkv.a $(SIMULATOR_OUTDIR)/libspotkv.a
	lipo -create $(DEVICE_OUTDIR)/libspotkv.a $(SIMULATOR_OUTDIR)/libspotkv.a -output $@
...
$(STATIC_OUTDIR)/libspotkv.a:$(STATIC_LIBOBJECTS)
	rm -f $@
